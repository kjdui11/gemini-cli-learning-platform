...
function fixFileOperationsTranslation(langCode) {
  ...
  try {
    ...
    console.log(`✅ Fixed file-operations translations for ${langCode}`);
    ...
    console.error(`❌ Error fixing ${langCode}.json:`, error.message);
  }
}

// Fix all languages
console.log('🔧 Fixing file-operations translations for all languages...\n');
...
console.log('✅ File-operations translations fixed for all languages!');
console.log('📋 All languages now have complete file-operations content with proper UI translations.');
